...
export const Test: FC = () => {
  ...
  const modeDefaultValue = modeOptions.find((opt) => opt.value === testKeyboardSoundsSettings.mode);
        ...
        <BottomSectionContent>
          <Container>
            <ControlRow>
              ...
              <Detail>
                <AccentButton onClick={testContextObj.clearTestKeys}>{t("Reset")}</AccentButton>
              </Detail>
            </ControlRow>
            <ControlRow>
