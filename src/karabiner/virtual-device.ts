...
export const macbookEditableKeys = macbookLayoutKeys.filter((key) => !key.displayOnly);
export const macbookKeys = macbookEditableKeys;

export const getMacbookKeyLabel = (key: { displayLabel?: string }) => key.displayLabel;
  ...
  layouts: {
    ...
    keys: macbookLayoutKeys.map(
      ({
        ...
        displayTopLabel: _displayTopLabel,
        displayBottomLabel: _displayBottomLabel,
        displayOnly,
        ...viaKey
      }) => ({
        ...viaKey,
